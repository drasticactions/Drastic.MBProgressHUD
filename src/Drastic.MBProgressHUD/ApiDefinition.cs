...
namespace Drastic.MBProgressHUD
{
    ...
    interface MBProgressHUD
    {
        ...
        // +(MBProgressHUD * _Nullable)HUDForView:(UIView * _Nonnull)view __attribute__((swift_name("forView(_:)")));
        [Static]
        [Export("HUDForView:")]
        [return: NullAllowed]
        ...
        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIColor * contentColor __attribute__((annotate("ui_appearance_selector")));
        [Export("contentColor", ArgumentSemantic.Strong)]
